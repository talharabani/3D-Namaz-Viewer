...
const AIChatComponent = ({ onClose, initialQuestion = '' }) => {
  ...
  const handleSendMessage = async (message = inputMessage) => {
    ...
    try {
      ...
      // Don't show error for fallback responses
        ...
        <div className="bg-gradient-to-r from-brass to-wood text-white p-4 rounded-t-3xl flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm opacity-90">Ask me anything about Islam, prayers, and guidance</p>
            </div>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="flex gap-2">
            <div className="flex-1 relative">
              <textarea
                ...
                placeholder="Ask me about Islamic knowledge, prayers, or guidance..."
